...
namespace Samotorcan.HtmlUi.Core.Exceptions
{
    ...
    public class ControllerNotFoundException : Exception, INativeException
    {
        ...
        /// <param name="controllerName">Name of the controller.</param>
        public ControllerNotFoundException(string message, string controllerName)
            : base(message)
        {
            ControllerName = controllerName;
        }
        ...
        public ControllerNotFoundException(string format, params object[] args)
        ...
        /// <param name="args">The arguments.</param>
        public ControllerNotFoundException(string format, Exception innerException, params object[] args)
